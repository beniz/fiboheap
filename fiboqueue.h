		...
		public:
			...
			// accessors
				typename std::unordered_map<T, typename FibHeap<T>::FibNode*>::iterator find(T k) {
					typename std::unordered_map<T, typename FibHeap<T>::FibNode*>::iterator mit = fstore.find(k);
					return mit;
				}
				typename FibHeap<T>::FibNode* findNode(T k) {
					typename std::unordered_map<T, typename FibHeap<T>::FibNode*>::iterator mit = find(k);
					return mit->second;
				}
			// modifiers
